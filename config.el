...
;; Colors
(add-hook! '(emacs-lisp-mode-hook c-mode-hook c++-mode-hook) #'rainbow-delimiters-mode)
(add-hook! '(emacs-lisp-mode-hook c-mode-hook c++-mode-hook) #'rainbow-identifiers-mode)
