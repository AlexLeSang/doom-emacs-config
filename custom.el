(custom-set-variables
 ...
 '(safe-local-variable-values '((spell-fu-mode) (org-confirm-babel-evaluate)))
 ...
 '(warning-suppress-types '(((undo discard-info)) (lsp-mode))))
(custom-set-faces
